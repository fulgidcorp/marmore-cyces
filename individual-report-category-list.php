...
// $reports      = "select * from tbl_report_data where is_active=1 and is_delete=1 and report_industry='$title' order by report_date DESC LIMIT $start_from, $limit"; 
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-9" id="report_category_search_div">
                    ...
                    <div class="row relative-report blogs">
                        <?php 
                          if(isset($all_report_category_details) && !empty($all_report_category_details))
                          {
                             foreach($all_report_category_details as $reports)
                             {
