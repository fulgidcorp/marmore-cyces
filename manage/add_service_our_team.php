...
$mode 		= ($id<>'0') ? 'Edit' : 'Add';
$params     = array(":id" => $id);
$TypeArray	= $objTypes->fetchRow("SELECT * FROM tbl_service_our_team WHERE id = :id", $params);
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> <?=$mode?> Our Team <small></small> </h1>
    <ol class="breadcrumb">
      <li><a href="list_service_our_team.php"><i class="fa  fa-navicon"></i> List</a></li>
    </ol>
  </section>
  <!-- Main content -->
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary" >
          ...
          <form role="form" id="productForm"  method="post" action="act_service_our_team.php" onsubmit="return validateForm();" enctype="multipart/form-data">
           ...
           <input type="hidden" name="pgNo" id="pgNo" value="<?=$_REQUEST['pgNo']?>"  />
            <div class="box-body">
			  ...
			  <div class="form-group">
                ...
                <input type="text" class="form-control " id="name" name="name" value="<?=stripslashes($TypeArray['name'])?>" placeholder="Name" style="width:40%;">
              </div>
			  <div class="form-group">
                <label for="exampleInputEmail1">Position<?=MANDATORY?></label>
                <input type="text" class="form-control " id="position" name="position" value="<?=stripslashes($TypeArray['position'])?>" placeholder="Position" style="width:40%;">
              </div>
			  
			   <div class="form-group">
                  <label for="exampleInputEmail1">Image</label>
                  <input type="file" class="form-control " id="image" name="image" value="" placeholder="Team Image" style="width:40%;"  multiple="multiple">
                ...
                <a href="#"><img src="../uploads/team_images/<?=stripslashes($TypeArray['image'])?>"  onerror="this.style.display='none'" height="80" width="100" onclick='window.open("../uploads/blog/<?=stripslashes($TypeArray['blog_image'])?>","","width=600,height=600,scrollbars=Yes,resizable=yes")' /></a>
				<?php } ?>
              </div>
            ...
            <div class="box-footer">
              ...
              <a href="list_service_our_team.php?&pgNo=<?php echo intval(base64_decode($_REQUEST['pgNo'])); ?>" class="btn btn-danger" >Back</a>
            </div>
          </form>
        </div>
        <!-- /.box -->
...
jQuery(function(){
    jQuery('.img-wrap2 .close2').click(function() {
        ...
        if(confirm('Are you sure you want to delete selected images?')) {
           	window.location.href = '<?=base_url?>act_service_our_team.php?id='+id+'&param=rimg&prodid=<?php echo $id ?>&pgNo=<?=$_REQUEST['pgNo']?>';
