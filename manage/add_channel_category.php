...
$mode 		= ($id<>'0') ? 'Edit' : 'Add';
$params     = array(":id" => $id);
$TypeArray	= $objTypes->fetchRow("SELECT * FROM tbl_channel_category WHERE id = :id", $params);
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> <?=$mode?> Blog Category<small></small> </h1>
    <ol class="breadcrumb">
      <li><a href="list_channel_category.php"><i class="fa  fa-navicon"></i> List</a></li>
    </ol>
  </section>
  <!-- Main content -->
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary" >
          ...
          <form role="form" id="productForm"  method="post" action="act_channel_category.php" onsubmit="return validateForm();" enctype="multipart/form-data">
           ...
           <input type="hidden" name="pgNo" id="pgNo" value="<?=$_REQUEST['pgNo']?>"  />
            <div class="box-body">
			  <div class="form-group">
                ...
                <input type="text" class="form-control " id="category_name" name="category_name" value="<?=stripslashes($TypeArray['category_name'])?>" placeholder="Category Name" style="width:40%;">
              </div>
            ...
            <div class="box-footer">
              ...
              <a href="list_channel_category.php?&pgNo=<?php echo intval(base64_decode($_REQUEST['pgNo'])); ?>" class="btn btn-danger" >Back</a>
            </div>
          </form>
        </div>
        <!-- /.box -->
...
jQuery(function(){
    jQuery('.img-wrap2 .close2').click(function() {
        ...
        if(confirm('Are you sure you want to delete selected images?')) {
           	window.location.href = '<?=base_url?>act_channel_category.php?id='+id+'&param=rimg&prodid=<?php echo $id ?>&pgNo=<?=$_REQUEST['pgNo']?>';
...
function validateForm(){
	if($("input#category_name").val()==""){
		$(".errorDiv").show().fadeOut(4000);
		$('#errormessage').text("Category Name is Mandatory");
