...
var STATIC_ELEMENT_CONFIG = {
    ...
    <div class="row">
      ...
      <div class="col-lg-6 ">
        <div class="text-right world-img"> <img src="{image_src_2}" alt="world"> </div>
    ...
    <div class="col-lg-5">
      <div class="card top-card text-left">
          ...
          <span style="margin-bottom:0.5em;display:inline-block;">{date_{i}}</span>
      ...
      <div class="btnn"><a class="btn btn-theme" href=reports/><span>Explore More</span></a></div>
    </div>
    ...
    values: get_values_for_multiple(["title_{i}", "caption_{i}","date_{i}", "button_text_{i}", "button_link_{i}"],10),
    css_config: {}
    },
    home_tab_section_2:{
          ...
          <div class="item">
            <div class="card blog-card">
              <div class="row no-gutters align-items-center">
                <div class="col-sm-5">
                  <img class="card-img" src="{image_src_1}" style="width: 250px;" alt="alt-img">
                </div>
              ...
              <div class="row no-gutters align-items-center">
                <div class="col-sm-5">
                  <img class="card-img" src="{image_src_{i}}" style="width: 250px;" alt="alt-img">
                </div>
                <div class="col-sm-7 align-items-center">
                  <div class="card-body">
    ...
    home_third_section:{
      ...
      <div class="card" >
           <div class="row no-gutters align-items-center b1">
            <div class="col-sm-5">
              <img class="card-img" src="{image_src_{i}}" alt="alt-img">
            </div>
            <div class="col-sm-7 align-items-center">
              <div class="card-body">
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <div class="p-content">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <img src="{image_src_2}" alt="" style="height:60px">
                </div>
                <div class="col-lg-4">
                  <img src="{image_src_3}" alt="" style="height:60px">
                 </div> 
                <div class="col-lg-4">
                  <img src="{image_src_4}" alt="" style="height:60px">
                </div> 
            </div>
            </div>
        </div>
...
`,
    ...
    <div class="content-wrap pt-3">
      <section id="section-line-1" class="content-current">
        <div class="row">
          <div class="col-lg-4">
            <div class="card blog-b" style="width:400px">
              <img class="card-img-top" src="{image_src_1}" alt="Card image" style="width:100%">
              <div class="card-body ">
        ...
        <div class="col-lg-4">
            <div class="card blog-b" style="width:400px">
              <img class="card-img-top" src="{image_src_2}" alt="Card image" style="width:100%">
              <div class="card-body ">
        ...
        <div class="col-lg-4">
            <div class="card blog-b" style="width:400px">
              <img class="card-img-top" src="{image_src_3}" alt="Card image" style="width:100%">
              <div class="card-body ">
      ...
      ${get_code_for_multiple(`<section id="section-line-1" class="content-current">
        <div class="row">
          <div class="col-lg-4">
            <div class="card blog-b" style="width:400px">
              <img class="card-img-top" src="{image_src_{i}}" alt="Card image" style="width:100%">
              <div class="card-body ">
...
`,6,2)}
  ...
  home_daily_research_card:{
      html:` <section class="guides" id="">
        ...
        <a href="#"><img src="/assets/image/pdf1.png"  onerror="this.style.display='none'" height="50" width="40" onclick='window.open("{image_src_{1}}","","width=600,height=600,scrollbars=Yes,resizable=yes")' /></a>
    ...
    <div class="col-lg-3">
            <div class="icon-boxes-h1">
              <div class="icon text-left">
    <a href="#"><img src="/assets/image/pdf1.png"  onerror="this.style.display='none'" height="50" width="40" onclick='window.open("{image_src_{i}}","","width=600,height=600,scrollbars=Yes,resizable=yes")' /></a>
              </div>
            ...
            <div class="row vertical-align">
                ...
                <div class="col-lg-6 ">
                    <div class="text-right">
                        <img src="{image_src_1}" alt="world" class="banner-img1" width="600">
                    </div>
                </div>
            </div>
        </div>
      ...
      html:`<section class="about-icon pt-50 pb-50">
        <div class="container-fuild">
            <div class="row">
                <div class="col-lg-3">
                    <div class="icon-boxes">
                        <div class="icon text-left"><img src="{image_src_1}" alt=""></div>
            ...
            ${get_code_for_multiple(`
                <div class="col-lg-3">
                    <div class="icon-boxes">
                        <div class="icon text-left"><img src="{image_src_{i}}" alt=""></div>
            ...
            <div class="text-center icon-btn">
                <a class="btn btn-2 btn-icon" href="/uploads/corporateprofile/Marmore Brochure_Aug 2022_V1.pdf" target="_blank"><span>Download Corporate Profile</span></a>
            </div>
        </div>
    </section>`,
  ...
  about_us_card_section:{
      html:`<div class="card-section">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card card-a">
                        <img class="card-img" src="{image_src_1}" alt="">
                        <div class="card-body ">
            ...
            ${get_code_for_multiple(`
                <div class="col-lg-4">
                    <div class="card card-a">
                        <img class="card-img" src="{image_src_{i}}" alt="">
                        <div class="card-body ">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="icon-boxes-a">
                        <div class="icon text-center"><img src="{image_src_1}" alt=""></div>
                        <h3 class="text-center icon-content">{heading_1}</h3>
                    </div>
                </div>
                ${get_code_for_multiple(`<div class="col-lg-3">
                    <div class="icon-boxes-a">
                        <div class="icon text-center"><img src="{image_src_{i}}" alt=""></div>
                        <h3 class="text-center icon-content">{heading_{i}}</h3>
                    </div>
                </div>`,4,2)}
            </div>
            <div class="text-center icon-btn b1">
                <a class="btn btn-2 btn-icon" href="/en/reports"><span>Disover Our Resources</span></a>
            </div>
        </div>`,
      ...
      html:` <section class="career-blog">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="card card-a">
                        <img class="card-img" src="{image_src_1}" alt="Card image">
                        <div class="card-body ">
                            <h4 class="card-title text-left">{heading_1}</h4>
                ...
                <div class="col-lg-6">
                    <div class="card card-a">
                        <img class="card-img" src="{image_src_2}" alt="Card image">
                        <div class="card-body ">
      ...
      html:`<section class="" id="">
            <div class="card-section">
                <div class="row data-booki">
                    ...
                    <div class="col-lg-3">
                        <div class="icon-boxes i-data">
                            <div class="icon text-left"><img src="{image_src_2}" alt=""></div>
                            <p>{content_2}</p>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="icon-boxes i-data">
                            <div class="icon text-left"><img src="{image_src_3}" alt=""></div>
                            <p>{content_3}</p>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="icon-boxes i-data">
                            <div class="icon text-left"><img src="{image_src_4}" alt=""></div>
                            <p>{content_4}</p>
                        </div>
                    </div>
                ...
                <div class="text-center icon-btn b1">
                <a class="btn btn-2 btn-icon" href="/uploads/corporateprofile Advisors_V6.pdf" target="_blank"><span>Download Corporate Profile</span></a>
            </div>
            </div>
        </section>
`,
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="direct-boxes">
                        <div class="direct text-center"><img src="{image_src_1}" alt=""></div>
                ...
                <div class="col-lg-3">
                    <div class="direct-boxes">
                        <div class="direct text-center"><img src="{image_src_2}" alt=""></div>
                ...
                <div class="col-lg-3">
                    <div class="direct-boxes">
                        <div class="direct text-center"><img src="{image_src_3}" alt=""></div>
                ...
                <div class="col-lg-3">
                    <div class="direct-boxes">
                        <div class="direct text-center"><img src="{image_src_4}" alt=""></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="direct-boxes">
                        ...
                        <h3 class="text-center direct-content">{heading_3}</h3>
                        <p class="direct-text text-center">{caption_3}</p>
                        <a href="{button_link_3}" target="_blank" class="center-icon"><i class="fa-brands fa-linkedin"></i></a>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="direct-boxes">
...
`,
      values: ["heading_1","image_src_1","caption_1","button_link_1","heading_2","image_src_2","caption_2","button_link_2","heading_3","image_src_3","caption_3","button_link_3","heading_4","image_src_4","caption_4"],
    css_config: {}
  },
  service_banner: {
        ...
        <div class="content content1"><div class="row pb-5">
                <div class="col-lg-6">
                    <div>
                        ...
                        <div class="major-content">
                            ...
                            <p class="sub-title subtitle pt-3">{content_1}</p>
                            <a class="btn btn-theme" href="/en/enquiry"><span>Talk to us</span></a>
                ...
                <div class="col-lg-6 ">
                    <div class="text-right world-img">
                        <img src="{image_src_1}" alt="world" width="600">
                    </div>
      ...
      html:`<div class="card-section" id="section-line-2">
           <h1 class="pt-3 pb-2 text-center bold  title">Our Process</h1>
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="icon-boxes-a">
                        <div class="icon text-center"><img src="{image_src_2}" alt=""></div>
                        <h3 class="text-center icon-content">{heading_2}</h3>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="icon-boxes-a">
                        <div class="icon text-center"><img src="{image_src_3}" alt=""></div>
...
`,
  ...
  banner_with_content:{
      html:`<section class="banner">
            <img src="{image_src_1}" alt="" class="banner-img b1">
            <div class="input-group mb-3 search search1" style="margin-top: -355px;">
                ...
                <div class="row">
                    <div class="col-lg-4 data-b">
                        <div class="card card-d ">
                            <img class="card-img" src="{image_src_1}" alt="{heading_1}">
                            <div class="card-body ">
                    ...
                    <div class="col-lg-4 data-b">
                        <div class="card card-d ">
                            <img class="card-img" src="{image_src_2}" alt="{heading_2}">
                            <div class="card-body ">
                    ...
                    <div class="col-lg-4 data-b">
                        <div class="card card-d ">
                            <img class="card-img" src="{image_src_3}" alt="{heading_3}">
                            <div class="card-body ">
      ...
      html:`<section class="industry-blog" id="section-line-4">
            <div class="container">
                <div class="row blogs service-related-blog">
                    <div class="col-lg-4 blog_1"  onclick='window.open("{btn_link_1}","_blank")'>
                        <div class="card blog-b border">
                            <img class="card-img-top" src="{image_src_1}" alt="Card image">
                            <div class="card-body ">
                                <a href="{category_link_1}" class="btn-link" target="_blank">{category_name_1}</a>
                ...
                ${get_code_for_multiple(`
                    <div class="col-lg-4 blog_1" onclick='window.open("{btn_link_{i}}","_blank")'>
                        <div class="card blog-b border">
                            <img class="card-img-top" src="{image_src_{i}}" alt="Card image">
                            <div class="card-body ">
                                <a href="{category_link_{i}}" class="btn-link" target="_blank">{category_name_{i}}</a>
  ...
  news_blog: {
      html:`<div class="card1" style="padding-top: 40px;">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="card card_m">
                                <img class="card-img-top" src="{image_src_2}" alt="Card image"
                                    style="width:100%">
                                <div class="card-body card_client">
                        ...
                        <div class="col-lg-3">
                            <div class="card card_m">
                                <img class="card-img-top" src="{image_src_3}" alt="Card image"
                                    style="width:100%">
                                <div class="card-body card_client">
                        ...
                        <div class="col-lg-3">
                            <div class="card card_m">
                                <img class="card-img-top" src="{image_src_4}" alt="Card image"
                                    style="width:100%">
                                <div class="card-body card_client">
  ...
  blog_card:{
      html:`<section class="guides blog-list"><div class="row">
            <div class="col-lg-4">
             ...
             ${get_code_for_multiple(`<div class="col-lg-4">
                <div class="card blog-b">
                    <img class="card-img-top" src="{image_src_{i}}" alt=""
                        style="width:100%">
                    <div class="card-body ">
                ...
                <div class="card blog-card">
                    <div class="row no-gutters align-items-center">
                        <div class="col-sm-4" style="text-align: center;">
                            <img class="card-img" src="{image_src}" style="width: 300px;" alt="alt-img">
                        </div>
                        <div class="col-sm-8 align-items-center">
                            <div class="card-body cd1">
                                ...
                                <a class="btn btn-2" href="/en/reports" style="border-radius: 0;color:#FFFFFF"><span>View All Reports</span></a>
